             ...
             Question
                ...
                <div class="d-flex pr-3">
                    <svg
                        ...
                        viewBox="172 228 70 50">
                        <g
                            name="서울"
                            i:layer="yes"
                            i:dimmedPercent="50"
                            i:rgbTrio="#000000000000"
                            seq="1"
                            class="md-trigger"
                            data-modal="modal-3"
                            id="svgSeoul">
    ...
    mounted(){
        console.log(this.dArray + "지역별게시글정보");
         $("g")
            ...
            []
                .forEach
                .call(document.querySelectorAll('path.land'), function (item) {
